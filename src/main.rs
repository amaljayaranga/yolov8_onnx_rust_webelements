...
// of bounding boxes.
// Returns a JSON array of objects bounding boxes in format [(x1,y1,x2,y2,object_type,probability,color),..]
#[post("/", data = "<file>")]
...
fn detect_objects_on_image(buf: Vec<u8>) -> Vec<(f32,f32,f32,f32,&'static str,f32, &'static str)> {
...
fn run_model(input:Array<f32,IxDyn>) -> Array<f32,IxDyn> {
    let env = Arc::new(Environment::builder().with_name(MODEL_NAME).build().unwrap());
    let model = SessionBuilder::new(&env).unwrap().with_model_from_file(MODEL_WEIGHT).unwrap();
...
fn process_output(output:Array<f32,IxDyn>,img_width: u32, img_height: u32) -> Vec<(f32,f32,f32,f32,&'static str, f32, &'static str)> {
...
fn iou(box1: &(f32, f32, f32, f32, &'static str, f32, &'static str), box2: &(f32, f32, f32, f32, &'static str, f32, &'static str)) -> f32 {
    return intersection(box1, box2) / union(box1, box2);
}

// Function calculates union area of two boxes
// Returns Area of the boxes union as a float number
fn union(box1: &(f32, f32, f32, f32, &'static str, f32, &'static str), box2: &(f32, f32, f32, f32, &'static str, f32, &'static str)) -> f32 {
...
fn intersection(box1: &(f32, f32, f32, f32, &'static str, f32, &'static str), box2: &(f32, f32, f32, f32, &'static str, f32, &'static str)) -> f32 {
    let (box1_x1,box1_y1,box1_x2,box1_y2,_,_,_) = *box1;
    let (box2_x1,box2_y1,box2_x2,box2_y2,_,_,_) = *box2;
...
//Model weight name
const MODEL_WEIGHT: &str =  "yolom_100.onnx";

// Array of YOLOv8 class labels
const YOLO_CLASSES:[&str;2] = ["Button", "TextArea"];

//colors
const COLORS:[&str;2] = ["#00FF00", "#0000FF"];
